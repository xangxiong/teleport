...
function serialize_teleport_terminal_v1_DataChunk(arg) {
  if (!(arg instanceof v1_service_pb.DataChunk)) {
    throw new Error('Expected argument of type teleport.terminal.v1.DataChunk');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_terminal_v1_DataChunk(buffer_arg) {
  return v1_service_pb.DataChunk.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_teleport_terminal_v1_DownloadRequest(arg) {
  if (!(arg instanceof v1_service_pb.DownloadRequest)) {
    throw new Error('Expected argument of type teleport.terminal.v1.DownloadRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_teleport_terminal_v1_DownloadRequest(buffer_arg) {
  return v1_service_pb.DownloadRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
logout: {
  ...
  download: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: v1_service_pb.DownloadRequest,
    responseType: v1_service_pb.DataChunk,
    requestSerialize: serialize_teleport_terminal_v1_DownloadRequest,
    requestDeserialize: deserialize_teleport_terminal_v1_DownloadRequest,
    responseSerialize: serialize_teleport_terminal_v1_DataChunk,
    responseDeserialize: deserialize_teleport_terminal_v1_DataChunk,
  },
};
